...
- **It Works On My Machine phase**  stop trusting that the previous phases still
  ...
  [`IT-WORKS-ON-MY-MACHINE-README.md`](IT-WORKS-ON-MY-MACHINE-README.md).
...
[`IT-WORKS-ON-MY-MACHINE-README.md`](IT-WORKS-ON-MY-MACHINE-README.md) and the
...
```bash
git clone https://git.us.qwasar.io/package_it_216256_hjw_yb/package_it.git
cd package_it
mvn clean install
mvn verify package
```
...
[`COFFEE-CHAT-README.md`](COFFEE-CHAT-README.md) for the full console
...
Referring to Measuring Test Coverage Section in [It Works On My Machine phase](./IT-WORKS-ON-MY-MACHINE-README.md#measuring-test-coverage) for more details.
